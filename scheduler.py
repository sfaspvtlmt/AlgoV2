...
def start():
    ...
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Rajshekhar1\run.py')
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Rajshekhar2\run.py')
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Sumit1\run.py')
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Sumit2\run.py')
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Vijet1\run.py')
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Vijet2\run.py')
    # time.sleep(2)
    # os.startfile(r'C:\Users\arush\Documents\AlgoV2\Misc\Parag1\run.py')
    # time.sleep(2)
...
schedule.every().wednesday.at("09:51:10").do(start)
